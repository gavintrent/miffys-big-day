...
export class Base_Scene extends Scene {
    ...
    constructor() {
        ...
        this.shadowed_orange = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(1, 0.592, 0, 1), ambient: .3, diffusivity: 0.6, specularity: 0.4, smoothness: 64,
        ...
        this.shadowed_plastic = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(1, 1, 1, 1), ambient: 0.4, diffusivity: 0.6, specularity: 0, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        });
        this.shadowed_picnic = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(0.588, 0.294, 0, 1), ambient: 0.9, diffusivity: 0.8, specularity: 0, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        });
        this.shadowed_wall = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(1, 1, 1, 1), ambient: .6, diffusivity: 0.6, specularity: 0.4, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        })
        this.shadowed_red = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(1, 0, 0, 1), ambient: .3, diffusivity: 0.6, specularity: 0.4, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        })
        this.shadowed_green = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(0.082, 0.678, 0.039, 1), ambient: .3, diffusivity: 0.6, specularity: 0.4, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        })
        this.shadowed_yellow = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(0.8901960784313725, 0.7647058823529411, 0.06274509803921569, 1), ambient: 1, diffusivity: 0.6, specularity: 0.4, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        })
        this.shadowed_sky = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(0.00784313725490196, 0.49019607843137253, 0.8588235294117647, 1), ambient: .3, diffusivity: 0.6, specularity: 0.4, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        })
        this.shadowed_wood = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(0.231, 0.184, 0.113, 1), ambient: 0.9, diffusivity: 0.1, specularity: 0, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        });
        this.shadowed_zoo_text = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(0, 0, 0, 1), ambient: 1, diffusivity: 0, specularity: 0, smoothness: 64,
            color_texture: new Texture("assets/text.png"),
            light_depth_texture: null
        });
        this.shadowed_path = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(0.788, 0.686, 0.482, 1), ambient: 0.9, diffusivity: 0.1, specularity: 0, smoothness: 64,
            color_texture: null,
            light_depth_texture: null
        });
        this.shadowed_text_image = new Material(new Shadow_Textured_Phong_Shader(1), {
            color: color(0, 0, 0, 1), ambient: 1, diffusivity: 0, specularity: 0, smoothness: 64,
            color_texture: new Texture("assets/text.png"),
            light_depth_texture: null
        });
    ...
    render_scene(context, program_state, shadow_pass, draw_light_source=false, draw_shadow=false) {
        ...
        this.shapes.cube.draw(context, program_state, ground_transform, shadow_pass? this.grass: this.pure);
        ...
        this.shapes.cube.draw(context, program_state, house_transform,
    ...
    display(context, program_state) {
        ...
        if (!context.scratchpad.controls) {
            ...
            program_state.set_camera(Mat4.look_at(vec3(0, 0, 50), vec3(0, 0, 0), vec3(0, 1, 0))); // Locate the camera here
        }
